                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <h3 class="md:text-right">
                            ...
                            @else
                                <span class="text-red-500">{{ ucfirst("$invoice->delivery_status") }}<svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-5 w-5 inline mb-1" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                        ...
                        <h3 class="md:col-span-2">
                            <strong>Remarks: </strong><i>{{ $invoice->deliveryRemark ? $invoice->deliveryRemark->remark : ''; }}</i>
                        </h3>
                        <button type="button"
