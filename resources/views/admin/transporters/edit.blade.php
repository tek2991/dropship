                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="email" class="block mt-1 w-full" type="email" required
                                    value="{{ $transporter->user->email }}" name="email" />
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <ol class="list-decimal pl-4">
                            @foreach ($transporter->locations as $location)
                                <li>
                                    <form
                                        action="{{ route('admin.transporters.remove.location', ['transporter' => $transporter->id]) }}"
                                        method="post">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <form method="POST"
                        action="{{ route('admin.transporters.add.location', ['transporter' => $transporter->id]) }}">
                        @method('PUT')
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
