                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @error('amount')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                            <x-input id="amount" class="block mt-1 w-full" type="number" name="amount" required disabled="{{ $error }}"
                                wire:model="amount" />
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            @error('remark')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                            <x-input id="remark" class="block mt-1 w-full" type="text" name="remark" required disabled="{{ $error }}"
                                wire:model="remark" />
                        </div>
                    </div>
                    <div class="flex items-center justify-end mt-4 ">
                        <x-button class="ml-3" type="submit" disabled="{{ $error }}">
