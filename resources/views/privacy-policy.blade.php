<x-guest-layout>
    <div class="min-h-screen my-14 max-w-6xl mx-auto px-4">
        ...
        <h1 class="text-2xl font-bold mt-8 mb-1">Privacy Policy</h1>
        <p class="text-gray-600 mb-8 font-semibold">Last updated: January 12, 2023</p>
        ...
        <h1 class="text-2xl font-bold mt-8 mb-1">Interpretation and Definitions</h1>
        <h2 class="text-xl font-semibold mt-3 mb-1">Interpretation</h2>
        ...
        <h2 class="text-xl font-semibold mt-3 mb-1">Definitions</h2>
        ...
        <ul class="list-disc pl-8">
            ...
            <li>
                <p><strong>Application</strong> refers to VPS Tracking, the software program provided by the Company.
                </p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Vaaps Agency, Sikaria Compound GS Road, Guwahati PIN
                    -781005.</p>
            </li>
            <li>
        ...
        <h1 class="text-2xl font-bold mt-8 mb-1">Collecting and Using Your Personal Data</h1>
        <h2 class="text-xl font-semibold mt-3 mb-1">Types of Data Collected</h2>
        <h3 class="text-lg font-semibold mt-2 mb-0">Personal Data</h3>
        ...
        <h3 class="text-lg font-semibold mt-2 mb-0">Usage Data</h3>
        ...
        <h3 class="text-lg font-semibold mt-2 mb-0">Information Collected while Using the Application</h3>
        ...
        <h2 class="text-xl font-semibold mt-3 mb-1">Use of Your Personal Data</h2>
        <p class="font-xl mt-2 mb-1 font-semibold">The Company may use Personal Data for the following purposes:</p>
        <ul class="list-disc pl-8">
            <li>
        ...
        <p class="font-xl mt-2 mb-1 font-semibold">We may share Your personal information in the following situations:
        </p>
        <ul class="list-disc pl-8">
        ...
        <h2 class="text-xl font-semibold mt-3 mb-1">Retention of Your Personal Data</h2>
        ...
        <h2 class="text-xl font-semibold mt-3 mb-1">Transfer of Your Personal Data</h2>
        ...
        <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
            ...
            information.</p>
        <h2 class="text-xl font-semibold mt-3 mb-1">Delete Your Personal Data</h2>
        ...
        <p>Please note, however, that We may need to retain certain information when we have a legal obligation or
            lawful
            basis to do so.</p>
        <h2 class="text-xl font-semibold mt-3 mb-1">Disclosure of Your Personal Data</h2>
        <h3 class="text-lg font-semibold mt-2 mb-0">Business Transactions</h3>
        ...
        <h3 class="text-lg font-semibold mt-2 mb-0">Law enforcement</h3>
        ...
        <h3 class="text-lg font-semibold mt-2 mb-0">Other legal requirements</h3>
        ...
        <h2 class="text-xl font-semibold mt-3 mb-1">Security of Your Personal Data</h2>
        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the
            Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable
            means
            to protect Your Personal Data, We cannot guarantee its absolute security.</p>
        <h1 class="text-2xl font-bold mt-8 mb-1">Children's Privacy</h1>
        ...
        <h1 class="text-2xl font-bold mt-8 mb-1">Links to Other Websites</h1>
        ...
        <h1 class="text-2xl font-bold mt-8 mb-1">Changes to this Privacy Policy</h1>
        ...
        <h1 class="text-2xl font-bold mt-8 mb-1">Contact Us</h1>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul class="list-disc pl-8">
            <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                    data-cfemail="7a090f0a0a15080e3a0c0a09570e081b191113141d541314">[support@vps-tracking.in]</a></li>
        </ul>
        <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>

        {{-- Back to top --}}
        <div class="fixed bottom-0 right-0 mb-4 mr-4">
            <a href="#top" class="text-gray-500 hover:text-gray-600">
